...
public class Shaders {
    ...
    public static void onRegisterShaders(RegisterShadersEvent event) throws IOException {
        event.registerShader(new ShaderInstance(
                        ...
                        ResourceLocation.fromNamespaceAndPath(JackieCraftTalismans.MOD_ID, "white_entity"),
        ...
        event.registerShader(new ShaderInstance(
                        event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(JackieCraftTalismans.MOD_ID, "fly_basic"),
                        DefaultVertexFormat.NEW_ENTITY
                ),
                shader -> flyBasicShader = shader);
        event.registerShader(new ShaderInstance(
                        event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(JackieCraftTalismans.MOD_ID, "top_fade"),
                        DefaultVertexFormat.NEW_ENTITY
                ),
                shader -> topFadeShader = shader);
        event.registerShader(new ShaderInstance(
                        event.getResourceProvider(),
                        ResourceLocation.fromNamespaceAndPath(JackieCraftTalismans.MOD_ID, "entity_translucent_emissive_adjustable"),
                        DefaultVertexFormat.NEW_ENTITY
                ),
