package com.fanxing.jackie_craft_talismans.entity.dialogue;
...
public class EntityDialogue {
    public static final String CLICK_COMMAND_PACKET_PRE = "#packet:"+ JackieCraftTalismans.MOD_ID+":";
    ...
    public static void showDialogue(ServerPlayer player, Entity entity, String phase) {
        ...
        // 例如：entity.jackie_craft_talismans.sans.dialogue.mercy
