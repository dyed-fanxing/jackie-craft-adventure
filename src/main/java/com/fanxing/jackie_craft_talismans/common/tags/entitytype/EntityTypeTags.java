package com.fanxing.jackie_craft_talismans.common.tags.entitytype;
...
public interface EntityTypeTags {
    ...
    private static TagKey<EntityType<?>> create(String name) {
        return TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath(JackieCraftTalismans.MOD_ID,name));
    }
}
