...
import com.fanxing.jackie_craft_talismans.entity.capability.Mountable;
...
public abstract class MountCrosshairGuiMixin {
    @Unique
    private static final ResourceLocation MOUNT_CROSSHAIR = ResourceLocation.fromNamespaceAndPath(JackieCraftTalismans.MOD_ID, "hud/mount_crosshair");
