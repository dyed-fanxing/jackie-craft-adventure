...
@Mod(JackieCraftTalismans.MOD_ID)
public class JackieCraftTalismans {
    // 在公共位置定义mod id供所有内容引用
    public static final String MOD_ID = "jackie_craft_talismans";
    public static final Logger LOGGER = LogUtils.getLogger();


    // 模组类的构造函数是模组加载时运行的第一段代码
    public JackieCraftTalismans(IEventBus modEventBus, ModContainer modContainer) {
