...
import com.fanxing.jackie_craft_adventure.client.model.item.PigTalismanItemModel;
...
public class PigTalismanItemRender extends GeoItemRenderer<PigTalismanItem> {
    ...
    public static void onRenderPost(RenderLivingEvent.Post<LivingEntity, ?> event) {
        ...
        UsingInfo usingCurio = CurioSetup.HELPER.getUsingCurio(entity, Config.CURIO_TALISMAN_SLOT, ItemTypesJCA.PIG_TALISMAN.get());
        if (usingCurio != null) {
