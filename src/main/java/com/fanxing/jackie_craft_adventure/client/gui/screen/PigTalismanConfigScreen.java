package com.fanxing.jackie_craft_adventure.client.gui.screen;

import com.fanxing.jackie_craft_adventure.client.gui.component.PigTalismanEffectPreview;
...
public class PigTalismanConfigScreen extends Screen {
    ...
    public PigTalismanConfigScreen(LivingEntity entity) {
        ...
        Button savePreset = new Button.Builder(
                Component.translatable("selectWorld.edit.save").append(Component.translatable("gui."+FxLib.MOD_ID+".preset")),
    ...
    private FlexBoxLayout createHeadEyePanel(LivingEntity entity) {
        ...
        if (entity instanceof Player) {
            ...
            headSlider = StepSlider.createWithOptionName(0, 0, panelWidth, 20,
                    ...
                    Component.translatable("gui."+MOD_ID+".head_pivot_logic_eye_offset"),
                    val -> currentOffset.setHeadPivotLogicEyeOffset(val.floatValue())
            );
            headSlider.setTooltip(Tooltip.create(Component.translatable("gui."+MOD_ID+".head_pivot_logic_eye_offset_tooltip")));
        ...
        eyeHeightSlider = StepSlider.createWithOptionName(0, 0, panelWidth, 20,
                ...
                Component.translatable("gui."+MOD_ID+".eye_height_offset"),
                val -> currentOffset.setEyeHeight(val.floatValue())
        );
        eyeHeightSlider.setTooltip(Tooltip.create(Component.translatable("gui."+MOD_ID+".eye_height_offset_tooltip")));
        surfaceSlider = StepSlider.createWithOptionName(0, 0, panelWidth, 20,
                ...
                Component.translatable("gui."+MOD_ID+".eye_surface_offset"),
                val -> currentOffset.setEyeSurfaceOffset(val.floatValue())
        );
        surfaceSlider.setTooltip(Tooltip.create(Component.translatable("gui."+MOD_ID+".eye_surface_offset_tooltip")));
        gapSlider = StepSlider.createWithOptionName(0, 0, panelWidth, 20,
                eyeGapMin, eyeGapMax, 0.005, currentOffset.eyeGap(), 2,
                Component.translatable("gui."+MOD_ID+".eye_gap"),
    ...
    private FlexBoxLayout createColorPickerPanel(List<Integer> colors) {
        ...
        if (colors != null) {
            for (int i = 0; i < colors.size(); i++) {
                ...
                }, Component.translatable("gui."+MOD_ID+"." + labels[i]));
